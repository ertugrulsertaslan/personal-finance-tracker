...
function App() {
  ...
  return (
    <>
      <div className="flex w-full h-screen justify-center p-5 bg-customDashboardColor text-white">
        <div className="w-full sm:w-auto md:w-1/4 lg:w-1/4 xl:w-1/4 p-5 mr-10">
          <Menu />
        </div>
